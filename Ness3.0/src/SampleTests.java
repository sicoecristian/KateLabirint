...
public class SampleTests {
    ...
    public SampleTests(String[] mze, boolean ex, String nme, boolean err) { name = nme; maze=mze; exp=ex; error=err; }

    @Test
    public void test() throws KateAlreadyExistException, NoKateInTheLabirintException, CanNotFindKateException {
        if (error) {
            try {
